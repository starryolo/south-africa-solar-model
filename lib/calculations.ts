...
// 阳光电源储能产品参数
export const SUNGROW_BATTERY_SPECS = {
  capacity: 10.0, // kWh 标准模块
  voltage: 51.2, // V
  depthOfDischarge: 0.9, // 90% DOD
  cycleLife: 6000, // 循环次数
  degradationRate: 0.02, // 年衰减率 2%
}
...
export const SOUTH_AFRICA_DEFAULTS: SystemConfig = {
  ...
  chargerPower: 7,
  chargerCount: 4,
  chargerPrice: 15000, // CNY

  inverterPower: 15,
  inverterCount: 5,
  inverterPrice: 20000, // CNY

  electricityBuyPrice: 1.2, // CNY/kWh (商业电价)
  electricitySellPrice: 0.5, // CNY/kWh
  chargingPrice: 1.8, // CNY/kWh
  dailyChargingHours: 8,
  chargerUtilization: 60,

  corporateTaxRate: 25, // 企业所得税
  vatRate: 13, // 增值税
...
export function calculateInvestmentModel(config: SystemConfig): CalculationResult {
  ...
  // 光伏板面积计算
  const panelArea = GCL_645W_SPECS.area * config.pvPanelCount // m²
